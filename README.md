...
Moreover, the server uses i) an [extended version of graphql-extensions](https://github.com/LiUGraphQL/graphql-extensions), ii) an [extended version of apollo-tracing-js](https://github.com/LiUGraphQL/apollo-tracing-js), and iii) an [extended version of Apollo-server-core (use the branch called AndreasLundquist)](https://github.com/LiUGraphQL/apollo-server-core/tree/AndreasLundquist).
